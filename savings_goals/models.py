...
class SavingsGoal(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name="savings_goals"
    )
...
class SavingsTransaction(models.Model):
    ...
    savings_goal = models.ForeignKey(
        SavingsGoal, on_delete=models.CASCADE, related_name="transactions"
    )
...
@property
def color_code(self):
    """Devuelve el color sugerido para la barra de progreso"""
